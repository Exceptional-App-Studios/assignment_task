...
/*
I have done this task using the package: charts_flutter, by getting json data using API, then converting it to a list of 
Point objects which is a class that I made to represent a point on the graph.
*/
